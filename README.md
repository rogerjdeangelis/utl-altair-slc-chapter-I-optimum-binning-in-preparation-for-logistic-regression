# utl-altair-slc-chapter-I-optimum-binning-in-preparation-for-logistic-regression
Altair slc chapter I optimum binning in preparation for logistic regression
    ...
    VIII   METHOD  (program
             ...
             8   Bin the numeric variables in groups with common odds ratios
                   Create a normalized (long and skinny binned table with just 5 variables)
    ...
    ---------------------
       ...
       OUTPUT CONTENTS FIVE TABLES
        ...
        5.  NORMAILIZED NUM  BINNED     940,000   d:/lgs/lgs_mgmNrmNumSrt.sas7bdat  13 vars*70000 observation
